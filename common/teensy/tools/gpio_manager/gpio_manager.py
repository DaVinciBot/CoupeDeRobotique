...
class GPIOManager:
    ...
    def is_valid_gpio(self, pin: int, type_actuator: ActuatorType = ActuatorType.UNKNOWN) -> bool:
        """
    ...
    def add_gpio(self, pin: int, type_actuator: ActuatorType = ActuatorType.UNKNOWN) -> bool:
        """
