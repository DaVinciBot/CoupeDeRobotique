...
from geometry import Point, Polygon, create_straight_rectangle, MultiPolygon, OrientedPoint
...
class MarsArena(Arena):
    ...
    def __init__(self, start_zone: int):
        ...
        self.drop_zones = [
            plants_zone(create_straight_rectangle(Point(45, 0), Point(0, 45))),  # 1 - Blue (Possible forbidden area)
            plants_zone(create_straight_rectangle(Point(122.5, 0), Point(77.5, 45))),  # 2 - Yellow
            plants_zone(create_straight_rectangle(Point(200, 0), Point(155, 45))),  # 3 - Blue
            plants_zone(create_straight_rectangle(Point(45, 255), Point(0, 300))),  # 4 - Yellow (Possible forbidden area)
            plants_zone(create_straight_rectangle(Point(122.5, 255), Point(77.5, 300))),  # 5 - Blue
            plants_zone(create_straight_rectangle(Point(200, 255), Point(155, 300))),  # 6 - Yellow
        ]
        ...
        self.gardeners = [
            (create_straight_rectangle(Point(77.5,-15), Point(45,-3)),False),  # 0 - Blue
            (create_straight_rectangle(Point(155,-15), Point(122.5,-3)),False),  # 1 - Yellow
            (create_straight_rectangle(Point(77.5,303), Point(45,315)),False),  # 2 - Blue
            (create_straight_rectangle(Point(155,303), Point(122.5,315)),False),  # 3 - Yellow
        ]
