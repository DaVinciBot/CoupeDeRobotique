...
from navigation.trajectory_planner.segments.rotation_segment import RotationSegment
...
from navigation.trajectory_planner.segments.straight_segment import StraightSegment
