...
//     float bearErr = _wrapToPi(_cmdPosition.theta - _currentPosition.theta);  // rad
...
float RollingBasis::getLinearSpeedMmPerS() const { return _linearSpeed; }
float RollingBasis::getAngularSpeedRadPerS() const { return _angularSpeed; }
