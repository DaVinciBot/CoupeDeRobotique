...
RelativeTurning::RelativeTurning(RollingBasis* rb, const double angle) : _rb(rb), _angle(angle) {
...
// a modifier : pas finis, le dist a changer, et regarder les éventuelles autres fonctions 
