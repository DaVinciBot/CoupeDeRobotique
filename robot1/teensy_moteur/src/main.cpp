...
#define LINEAR_DISTANCE_PID_ID = 2
#define ANGULAR_DISTANCE_PID_ID = 3
...
{
  msg_set_linear_speed_pid *pid_msg = (msg_set_linear_speed_pid *)msg;
  PID *pid = nullptr;
  is_valid_pid = true;
  ...
  case ANGULAR_SPEED_PID_ID:
    ...
    break;
  case LINEAR_DISTANCE_PID_ID:
    pid = &linear_distance_pid;
    break;
  case ANGULAR_DISTANCE_PID_ID:
