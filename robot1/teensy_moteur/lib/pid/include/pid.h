...
/**
 * @brief PID controller for servo-controlled motors with smooth deadband and dt limits.
 *
...
public:
     ...
     * @param dtMin         Minimum dt (s) for derivative computation (default 1e-3)
     * @param dtMax         Maximum dt (s) for integral/derivative (default 0.02)
     */
