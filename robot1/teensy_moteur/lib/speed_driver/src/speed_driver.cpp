...
void Speed_Driver::compute_acceleration_profile(
    ...
    if (this->acceleration_params.distance != 0.0f &&
        (this->acceleration_params.a == -1.0f ||
         this->acceleration_params.b == -1.0f ||
         this->acceleration_params.c == -1.0f)) {
        this->acceleration_params.a =
            this->acceleration_params.offset / this->max_speed;
        this->acceleration_params.b = this->acceleration_params.distance / 2;
        this->acceleration_params.c = logf(((1 - this->acceleration_params.a) /
                                            this->acceleration_params.p) -
                                           1.0f) /
                                      this->acceleration_params.b;
    }

    // Compute deceleration profile
    if (this->deceleration_params.distance != 0.0f &&
        (this->deceleration_params.a == -1.0f ||
         this->deceleration_params.b == -1.0f ||
         this->deceleration_params.c == -1.0f)) {
        this->deceleration_params.a =
            this->deceleration_params.offset / this->max_speed;
        this->deceleration_params.b = this->deceleration_params.distance / 2;
        this->deceleration_params.c = logf(((1 - this->deceleration_params.a) /
                                            this->deceleration_params.p) -
                                           1.0f) /
                                      this->deceleration_params.b;
    }
}
...
byte Speed_Driver::compute_local_speed(long ticks) {
    ...
    if (this->acceleration_params.distance != 0.0f)
        acceleration_speed = (byte)constrain(
            this->max_speed * (1.0f - this->acceleration_params.a) *
                    ((1.0f /
                      (1.0f + expf(-this->acceleration_params.c *
                                   (ticks - this->acceleration_params.b))))) +
                this->acceleration_params.a,
            this->acceleration_params.offset, this->max_speed);

    byte deceleration_speed = this->max_speed;
    if (this->deceleration_params.distance != 0.0f)
        deceleration_speed = (byte)constrain(
            this->max_speed * (1.0f - this->deceleration_params.a) *
                    ((1.0f / (1.0f + expf(-this->deceleration_params.c *
                                          (delta_ticks -
                                           this->deceleration_params.b))))) +
                this->deceleration_params.a,
            this->deceleration_params.offset, this->max_speed);
...
Speed_Driver_From_Distance::Speed_Driver_From_Distance(
    byte max_speed,
