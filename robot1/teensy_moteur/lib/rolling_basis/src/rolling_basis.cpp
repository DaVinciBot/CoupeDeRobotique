...
// Methods
// Inits function
void Rolling_Basis::init_right_motor(byte in2, byte in1, byte pwm, byte enca, byte encb, float kp, float kd, float ki, float correction_factor = 1.0, byte threshold_pwm_value = 0)
{
    this->right_motor = new Motor(enca, encb, pwm, in2, in1, kp, kd, ki, correction_factor, threshold_pwm_value);
}

void Rolling_Basis::init_left_motor(byte in2, byte in1, byte pwm, byte enca, byte encb, float kp, float kd, float ki, float correction_factor = 1.0, byte threshold_pwm_value = 0)
{
