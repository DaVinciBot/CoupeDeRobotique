...
class MainBrain(Brain):
    ...
    def run(self) -> None:
        ...
        rolling_basis.set_speed_and_position(0.0, 0.0, OrientedPoint(20, 25, 135)) # Point d'arrivée
        time.sleep(1)
        rolling_basis.set_speed_and_position(0.0, 0.0, OrientedPoint(80, 25, 135)) # Point d'arrivée
        #time.sleep(3)
