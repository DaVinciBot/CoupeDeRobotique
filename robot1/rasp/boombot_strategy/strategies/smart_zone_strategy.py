...
class SmartZoneStrategy(BaseStrategy):
    def __init__(self, ctx: WinterGameContext) -> None:
        ...
        deposit_graph_1 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[0],
            ctx,
        )
        deposit_graph_2 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[1],
            ctx,
        )
        deposit_graph_3 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[2],
            ctx,
        )
        deposit_graph_4 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[3],
            ctx,
        )
        deposit_graph_5 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[4],
            ctx,
        )
        deposit_graph_6 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[5],
            ctx,
        )
        deposit_graph_7 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[6],
            ctx,
        )
        deposit_graph_8 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[7],
            ctx,
        )
        deposit_graph_9 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[8],
            ctx,
        )
        deposit_graph_10 = get_deposit_jenga_deposit_zone_subgraph(
            self.deposit_zones_list[9],
            ctx,
        )
