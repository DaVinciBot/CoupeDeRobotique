...
class CONFIG:
    ...
    ACTUATOR_SERVOS_STORAGE = ACTUATORS_CONFIG["servos_storage"]
    ACTUATOR_CENTER_ARM = ACTUATOR_SERVOS_STORAGE["center"]
    ACTUACTOR_UPPER_ARM = ACTUATOR_SERVOS_STORAGE["upper_arm"]
    ACTUATOR_SIDE_ARMS = ACTUATOR_SERVOS_STORAGE["side_arms"]
    ACTUATOR_END_SERVOS = ACTUATOR_SERVOS_STORAGE["end_servos"]
